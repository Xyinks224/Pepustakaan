...
<div class="container">
    <div class="jumbotron">
            ...
            <form action="{{ action('PinjamController@update', 'pinjaman -> id') }}" method="POST">
            @csrf
            <div class="form-group">
                <label for="tipe_pinjam">Tipe Pinjam</label>
                <select name="tipe_pinjam" id="tipe_pinjam" class="form-control">
                    <option value="pinjam">Kembali</option>
                </select>
            </div>

            <div class="form-group">
                <label for="id_buku">Kode Buku</label>
                <input type="text" name="id_buku" placeholder="Kode Buku" class="form-control" value="{{ $pinjaman -> id_buku }}">
            </div>

            <div class="form-group">
                <label for="judul_buku">Judul Buku</label>
                <input type="text" name="judul_buku" id="judul_buku" placeholder="Judul Buku" value="{{ $pinjaman -> judul_buku }}" readonly="true">
            </div>

            <div class="form-group">
                <label for="judul_buku">Deskripsi Buku</label>
                <input type="text" name="deskripsi" id="deskripsi" placeholder="Deskripsi Buku" value="{{ $pinjaman -> deskripsi }}"  readonly="true">
            </div>

            <div class="form-group">
                <label for="judul_buku">Kategori Buku</label>
                <input type="text" name="kategori" id="kategori" placeholder="Kategori Buku" value="{{ $pinjaman -> kategori }}"  readonly="true">
            </div>
            ...
            <div class="form-group">
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <input type="date" name="tgl_pinjam" class="form-control" value="{{ $pinjaman -> tgl_pinjam }}" readonly="true">
                    </div>
            ...
            <div class="form-group">
                ...
                <input type="text" name="id_anggota" id="id_anggota" value="{{ $pinjaman -> id_anggota }}" class="form-control" readonly="true">
            </div>

            <div class="form-group">
                <label for="nama_anggota">Nama Peminjam</label>
                <input type="text" name="nama_anggota" id="nama_anggota" value="{{ $pinjaman -> nama_anggota }}" class="form-control" readonly="true">
            </div>
